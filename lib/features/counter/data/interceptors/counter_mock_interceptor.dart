...
/// Simula `POST …/counter/adjust` sin backend real.
///
/// Quitá este interceptor cuando el servidor implemente el mismo contrato.
class CounterMockInterceptor extends Interceptor {
  CounterMockInterceptor({
    this.networkDelay = const Duration(milliseconds: 300),
  });

  static const pathSegment = '/counter/adjust';
